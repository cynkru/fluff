...
Cynk - это платформа, где вы можете общаться, делиться моментами и находить единомышленников. Присоединяйтесь к нашему растущему сообществу и откройте для себя новый способ взаимодействия.


## Авторы
- [@stastpoff](https://github.com/stastpru/)
- [@krille-chan](https://github.com/krille-chan/)(огромное спасибо за оригинал)


## Поддержка
- mail@cynk.ru
- support@gonextteam.ru

## Исспользовано
Проект исспользуется следующими кампаниями
